...
public class Frase {
   ...
   /**
    * Devuelve el nï¿½mero de letras que hay en la cadena
    */
   ...
   public StringBuffer invertirFrase() {
      ...
      //Otra forma: usando el mï¿½todo append de StringBuffer
...
*/
   ...
   public String[] separarPalabras() {
      ...
      for (int i = 0; i < palabras.length; i++) {
         if (i == palabras.length - 1) {
            ...
            espacio = temp.indexOf(' ');          //posiciï¿½n del espacio
   ...
   /**
    * Devuelve la primera posiciï¿½n de una vocal en la cadena
   ...
   /**
    * Devuelve la ï¿½ltima posiciï¿½n de una vocal en la cadena
    * En caso de que no tenga vocales, devuelve -1    
    */
   ...
   /**
    * Devuelve true si la primera letra es mayï¿½scula y false si no lo es
    */       
   ...
   /**
    * Devuelve un StringBuffer con la cadena convertida a mayï¿½sculas
    */       
